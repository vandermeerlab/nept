...
def test_bayesian_prob_smalltc():
    ...
    counts = vdm.AnalogSignal(np.array([[10.], [5.]]), np.array([1.]))
    binsize = 1.0
...
def test_bayesian_prob_nospike():
    ...
    counts = vdm.AnalogSignal(np.array([[0.]]), np.array([1.]))
    binsize = 1.0
...
def test_bayesian_prob_multtc():
    ...
    counts = vdm.AnalogSignal(np.array([[0.], [4.], [2.]]), np.array([1.]))
...
def test_bayesian_prob_emptytcbin():
    ...
    counts = vdm.AnalogSignal(np.array([[0.], [2.], [2.]]), np.array([1.]))
...
def test_bayesian_prob_onepos():
    ...
    counts = vdm.AnalogSignal(np.array([[0., 2., 4.]]), np.array([1., 2., 3.]))
...
def test_bayesian_prob_multneurons():
    ...
    counts = vdm.AnalogSignal(np.array([[0., 8, 0.],
                                        [4., 0., 1.],
